...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/UUMARTEN/MARLY/main/File_Bot/commands.lua") 
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "مارلي")
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/UUMARTEN/MARLY/main/DRAGON.lua')
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/UUMARTEN/MARLY/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/UUMARTEN/MARLY/main/File_Bot/"..file)
if res == 200 then
...
{{text = 'القائمه الرائسيه', callback_data="/dev-kapos"}},
{{text = '〈〈⌯〈〉〈〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〉〈〉⌯〉〉', url="t.me/SO_MARLY"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
