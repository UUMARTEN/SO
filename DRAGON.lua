...
keyboard.inline_keyboard = {
{
{text = 'اوامر الحمايه ⇊', callback_data="/marly"},{text = 'ااوامر التسليه ⇊', callback_data="/dev-kapos"},
},
{
{text = 'اوامر الاعضاء ⇊', callback_data="/dev-marten"},{text = 'اوامر المطورين ⇊', callback_data="/help5"},
},
{
{text = 'ااوامر اصحاب الرتب ⇊', callback_data="/dev-marly"},
},
{
{text = '〈〈⌯〈〉〈〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〉〈〉⌯〉〉', url="t.me/SO_MARLY"},
},
