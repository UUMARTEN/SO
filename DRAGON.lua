...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ELKABOOOS/ROO/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/ELKABOOOS/ROO/main/DRAGON.lua')
...
{{text = '𝐝𝐞𝐯 𝐞𝐥𝐤𝐚𝐛??𝐨𝐬', url="t.me/G_W_P"}},
{{text = '𝐬𝐨𝐮𝐫𝐜𝐞 𝐫𝐨𝐨𝐠𝐞𝐧', url="t.me/SO_ROGEN"}},
...
if text == 'التواصل' or text == 'تواصل' then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ELKABOOOS/ROO/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ELKABOOOS/ROO/main/File_Bot/"..file)
if res == 200 then
...
Namebot = devROGEN_Msg[math.random(#devROGEN_Msg)] 
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {
{
